describe('geoHelper', function(){
  it("geoHelper calculates the distance between two geo points", function(){
  ...
  it("geoHelper returns true for value within set radius (.5m)", function(){
    expect(geoHelper.inRange([37.795134, -122.413548], [37.796186, -122.407025])).toEqual(true)
  })

  it("geoHelper returns false for value beyond set radius (.5m)", function(){
